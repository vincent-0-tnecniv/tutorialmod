...
public abstract class BaseAbstractContainerMenu extends AbstractContainerMenu {
    ...
    public ItemStack quickMoveStack(Player playerIn, int pIndex) {
        ...
        if (pIndex < VANILLA_FIRST_SLOT_INDEX + VANILLA_SLOT_COUNT) {
            ...
            TutorialMod.LOGGER.info("Invalid slotIndex: {}", pIndex);
            return ItemStack.EMPTY;
        }
    ...
    public boolean stillValid(Player player) {
        return stillValid(player, level(), blockEntity(), baseBlock());
    }

    protected <T extends BlockEntity, U extends Block> boolean stillValid(Player player, Level level, T blockEntity, U baseBlock) {
